...
export async function deleteChecklist(id: number): Promise<void> {
  await apiFetch<void>(`/api/materialidad/checklists/${id}/`, { method: "DELETE" });
}

export async function deleteChecklistItem(id: number): Promise<void> {
  await apiFetch<void>(`/api/materialidad/checklist-items/${id}/`, { method: "DELETE" });
}

export async function deleteDeliverableRequirement(id: number): Promise<void> {
  await apiFetch<void>(`/api/materialidad/entregables/${id}/`, { method: "DELETE" });
}
