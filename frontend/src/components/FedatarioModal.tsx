...
const INPUT =
  "w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-100";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="relative flex max-h-[90vh] w-[calc(100vw-2rem)] sm:w-full max-w-3xl flex-col rounded-3xl border border-slate-200 bg-white shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 px-6 py-4">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.35em] text-blue-600">Catálogo</p>
          ...
          {view === "list" ? (
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  onClick={openCreate}
                  className="whitespace-nowrap rounded-xl bg-blue-600 px-4 py-2 min-h-[44px] text-sm font-semibold text-white shadow-md hover:bg-blue-700 transition"
                >
                  + Nuevo
                </button>
              </div>
              ...
              <div className="space-y-2">
                {filtered.map((f) => (
                  <div
                    key={f.id}
                    className="flex items-start gap-3 rounded-2xl border border-slate-100 bg-slate-50 p-4 transition hover:border-blue-200 hover:bg-blue-50/30"
                  >
            ...
            <div className="space-y-5">
              <button
                ...
                className="text-sm font-medium text-blue-600 hover:text-blue-700 transition min-h-[44px] flex items-center"
              >
                ← Volver al listado
              </button>
        ...
        {view === "form" && (
          <div className="flex items-center justify-end gap-3 border-t border-slate-100 px-6 py-4">
            ...
            <button
              ...
              className="rounded-xl bg-blue-600 px-6 py-2 min-h-[44px] text-sm font-semibold text-white shadow-md hover:bg-blue-700 disabled:opacity-50 transition"
            >
