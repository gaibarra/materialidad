...
from .views import DespachoListView, TenantActivityMonitoringView, TenantProvisionView
...
urlpatterns = [
    ...
    path("superadmin/tenant-activity/", TenantActivityMonitoringView.as_view(), name="superadmin_tenant_activity"),
]
