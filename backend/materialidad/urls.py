...
from .views import (
    ...
    ChecklistViewSet,
    OperacionChecklistItemViewSet,
    AuditMaterialityDossierViewSet,
    ...
    EvidenciaMaterialViewSet,
    EmpresaViewSet,
    FedatarioViewSet,
    DeliverableRequirementViewSet,
    LegalCorpusUploadViewSet,
    ...
    AuditLogViewSet,
    AlertaCSDViewSet,
    AlertaOperacionViewSet,
    CotizacionPDFViewSet,
    ProveedorViewSet,
...
router.register("evidencias-materialidad", EvidenciaMaterialViewSet, basename="evidencia-materialidad")
router.register("audit-log", AuditLogViewSet, basename="audit-log")
router.register("materialidad-auditoria", AuditMaterialityDossierViewSet, basename="audit-materiality-dossier")
router.register("alertas-csd", AlertaCSDViewSet, basename="alerta-csd")
router.register("alertas-operacion", AlertaOperacionViewSet, basename="alerta-operacion")
...
router.register("corpus-legales", LegalCorpusUploadViewSet, basename="legal-corpus-upload")
...
router.register("operacion-checklist-items", OperacionChecklistItemViewSet, basename="operacion-checklist-item")
...
router.register("cotizaciones-pdf", CotizacionPDFViewSet, basename="cotizacion-pdf")
router.register(
...
urlpatterns = [
    ...
    path(
        "dashboard/metricas/cobertura-p0/",
        DashboardCoberturaP0View.as_view(),
        name="dashboard-cobertura-p0",
    ),
    path(
